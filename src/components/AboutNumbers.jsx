  ...
  return (
    ...
    <div className="px- py- mx-auto max-w-screen-xl sm:py- lg: xl:px-0">
        ...
        <Fade triggerOnce={true} duration={1000}>
            <div className="flex justify-center pt-8 items-center p-6 text-center  xl:p-12 dark:bg-gray-800 rounded-full ">
                <div className="text-white dark:text-white">
                    <p className="mb-4 text-4xl font-extrabold md:text-5xl">20+</p>
                    <h3 className="mb-2 text-xl font-semibold">Progetti</h3>
            ...
            <div className="flex justify-center items-center p-6 text-center  rounded-full xl:p-12 dark:bg-gray-800 ">
                <div className="text-white dark:text-white">
                    <p className="mb-4 text-4xl font-extrabold md:text-5xl">100%</p>
                    <h3 className="mb-2 text-xl font-semibold">Clienti Soddisfatti</h3>
                    <p className="font-light text-white dark:text-gray-400"></p>
                </div>
            </div>
            </Fade>
            ...
            <div className="flex justify-center pt-6 items-center p-6 text-center  xl:p-12 dark:bg-gray-800 rounded-full ">
                <div className="text-white dark:text-white">
                    <p className="mb-4 text-4xl font-extrabold md:text-5xl">3</p>
                    <h3 className="mb-2 text-xl font-semibold">Certificazioni</h3>
                    <p className="font-light text-white dark:text-gray-400"></p>
                </div>
            </div>
            </Fade>
